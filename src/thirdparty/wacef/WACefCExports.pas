...
const
  ...
  function cef_execute_process(const args:PCefMainArgs; application:PCefApp; windows_sandbox_info:Pointer): cint; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  // This function should be called on the main application thread to initialize
  // the CEF browser process. The |application| parameter may be NULL. A return
  // value of true (1) indicates that it succeeded and false (0) indicates that it
  // failed. The |windows_sandbox_info| parameter is only used on Windows and may
  // be NULL (see cef_sandbox_win.h for details).
  function cef_initialize(const args:PCefMainArgs; const settings:PCefSettings; application:PCefApp; windows_sandbox_info:Pointer): cint; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  // This function should be called on the main application thread to shut down
  // the CEF browser process before the application exits.
  procedure cef_shutdown; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  ...
  procedure cef_do_message_loop_work; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  ...
  procedure cef_run_message_loop; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  // Quit the CEF message loop that was started by calling cef_run_message_loop().
  // This function should only be called on the main application thread and only
  // if cef_run_message_loop() was used.
  procedure cef_quit_message_loop; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  // Set to true (1) before calling Windows APIs like TrackPopupMenu that enter a
  // modal message loop. Set to false (0) after exiting the modal message loop.
  procedure cef_set_osmodal_loop(osModalLoop: cint); cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  ...
  function cef_browser_host_create_browser(const windowInfo:PCefWindowInfo;
    client:PCefClient; const url:PCefString; const settings:PCefBrowserSettings;
    request_context:PCefRequestContext): cint; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};

  // Create a new browser window using the window parameters specified by
  // |windowInfo|. This function can only be called on the browser process UI
  // thread.
  function cef_browser_host_create_browser_sync(const windowInfo:PCefWindowInfo;
    client:PCefClient; const url:PCefString; const settings:PCefBrowserSettings;
    request_context:PCefRequestContext):PCefBrowser; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};

  {-------------------------------CefCommandLineCApi-------------------------------}
  // Create a new cef_command_line_t instance.
  function cef_command_line_create:PCefCommandLine; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  // Returns the singleton global cef_command_line_t object. The returned object
  // will be read-only.
  function cef_command_line_get_global:PCefCommandLine; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};

  {-------------------------------CefCookieCApi--------------------------------}
  // Returns the global cookie manager. By default data will be stored at
  // CefSettings.cache_path if specified or in memory otherwise.
  function cef_cookie_manager_get_global_manager:PCefCookieManager; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  ...
  // creation fails.
  function cef_cookie_manager_create_manager(const path:PCefString; persist_session_cookies: cint):PCefCookieManager; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};

  {----------------------------CefDragDataCApi------------------------------}
  // Create a new cef_drag_data_t object.
	function cef_drag_data_create:PCefDragData; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};

  {----------------------------CefGeolocationCApi------------------------------}
  // Request a one-time geolocation update. This function bypasses any user
  // permission checks so should only be used by code that is allowed to access
  // location information.
  function cef_get_geolocation(callback:PCefGetGeolocationCallback): cint; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  ...
  function cef_add_cross_origin_whitelist_entry(const source_origin:PCefString;
    const target_protocol:PCefString; const target_domain:PCefString; allow_target_subdomains: cint): cint; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  // Remove an entry from the cross-origin access whitelist. Returns false (0) if
  // |source_origin| is invalid or the whitelist cannot be accessed.
  function cef_remove_cross_origin_whitelist_entry(const source_origin:PCefString;
    const target_protocol:PCefString; const target_domain:PCefString; allow_target_subdomains: cint): cint; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  // Remove all entries from the cross-origin access whitelist. Returns false (0)
  // if the whitelist cannot be accessed.
  function cef_clear_cross_origin_whitelist: cint; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};

  {----------------------------CefPathUtilCApi---------------------------------}
  // Retrieve the path associated with the specified |key|. Returns true (1) on
  // success. Can be called on any thread in the browser process.
  function cef_get_path(key:TCefPathKey; path:PCefString): cint; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};

  {----------------------------CefPrintSettingCApi---------------------------------}
  // Create a new cef_print_settings_t object.
  function cef_print_settings_create:PCefPrintSettings; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};

  {----------------------------CefProcessMessageCApi---------------------------}
  // Create a new cef_process_message_t object with the specified name.
  function cef_process_message_create(const name:PCefString):PCefProcessMessage; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  ...
  function cef_launch_process(command_line:PCefCommandLine): cint; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};

  {----------------------------CefRequestCApi----------------------------------}
  // Create a new TCefRequest object.
  function cef_request_create:PCefRequest; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  // Create a new TCefPostData object.
  function cef_post_data_create:PCefPostData; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  // Create a new cef_post_data_Element object.
  function cef_post_data_element_create:PCefPostDataElement; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};

  {..........................cef_request_context_capi..........................}
  // Returns the global context object
	function cef_request_context_get_global_context:PCefRequestContext; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  // Creates a new context object with the specified handler.
	function cef_request_context_create_context(handler:PCefRequestContextHandler):PCefRequestContext; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};

  {----------------------------CefResponseCApi---------------------------------}
  // Create a new cef_response_t object.
  function cef_response_create:PCefResponse; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  ...
  function cef_register_scheme_handler_factory(const scheme_name:PCefString;
    const domain_name:PCefString; factory:PCefSchemeHandlerFactory): cint; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  // Clear all registered scheme handler factories. Returns false (0) on error.
  // This function may be called on any thread.
  function cef_clear_scheme_handler_factories: cint; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};

  {----------------------------CefSreamCApi------------------------------------}
  // Create a new cef_stream_reader_t object from a file.
  function cef_stream_reader_create_for_file(const fileName:PCefString):PCefStreamReader; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  // Create a new cef_stream_reader_t object from data.
  function cef_stream_reader_create_for_data(data:Pointer; size:Cardinal):PCefStreamReader; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  // Create a new cef_stream_reader_t object from a custom handler.
  function cef_stream_reader_create_for_handler(handler:PCefReadHandler):PCefStreamReader; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  // Create a new cef_stream_writer_t object for a file.
  function cef_stream_writer_create_for_file(const fileName:PCefString):PCefStreamWriter; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  // Create a new cef_stream_writer_t object for a custom handler.
  function cef_stream_writer_create_for_handler(handler:PCefWriteHandler):PCefStreamWriter; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};

  {----------------------------CefTaskCApi-------------------------------------}
  // Returns the task runner for the current thread. Only CEF threads will have
  // task runners. An NULL reference will be returned if this function is called
  // on an invalid thread.
  function cef_task_runner_get_for_current_thread:PCefTaskRunner; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  // Returns the task runner for the specified CEF thread.
  function cef_task_runner_get_for_thread(threadId:TCefThreadId):PCefTaskRunner; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  ...
  // wrong process.
  function cef_currently_on(threadId:TCefThreadId): cint; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  ...
  // process.
  function cef_post_task(threadId:TCefThreadId; task:PCefTask): cint; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  ...
  // process.
  function cef_post_delayed_task(threadId:TCefThreadId; task:PCefTask; delay_ms: cint64): cint; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  ...
  function cef_begin_tracing(const categories:PCefString; callback:PCefCompletionCallback): cint; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  ...
  //
  // This function must be called on the browser process UI thread.
	function cef_end_tracing(const tracing_file:PCefString; callback:PCefEndTracingCallback): cint; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  // Returns the current system trace time or, if none is defined, the current
  // high-res time. Can be used by clients to synchronize with the time
  // information in trace events.
	function cef_now_from_system_trace_time: cint64; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};

  {----------------------------CefUrlRequestCApi-------------------------------}
  // Create a new URL request. Only GET, POST, HEAD, DELETE and PUT request
  // functions are supported. The |request| object will be marked as read-only
  // after calling this function.
  function cef_urlrequest_create(request:PCefRequest; client:PCefUrlrequestClient):PCefUrlrequest; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};

  {----------------------------CefUrlCApi--------------------------------------}
  // Parse the specified |url| into its component parts. Returns false (0) if the
  // URL is NULL or invalid.
  function cef_parse_url(const url:PCefString; var parts:TCefUrlparts): cint; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  // Creates a URL from the specified |parts|, which must contain a non-NULL spec
  // or a non-NULL host and path (at a minimum), but not both. Returns false (0)
  // if |parts| isn't initialized as described.
  function cef_create_url(const parts:PCefUrlparts; url:PCefString): cint; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  // Returns the mime type for the specified file extension or an NULL string if
  // unknown.
  //
  // The resulting string must be freed by calling cef_string_userfree_free().
  function cef_get_mime_type(const extension:PCefString):PCefStringUserFree; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  // Get the extensions associated with the given mime type. This should be passed
  // in lower case. There could be multiple extensions for a given mime type, like
  // "html,htm" for "text/html", or "txt,text,html,..." for "text/*". Any existing
  // elements in the provided vector will not be erased.
  procedure cef_get_extensions_for_mime_type(const mime_type:PCefString; extensions:TCefStringList); cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  ...
  // </pre>
  function cef_register_extension(const extension_name:PCefString; const javascript_code:PCefString;
    handler:PCefV8handler): cint; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  // Returns the current (top) context object in the V8 context stack.
  function cef_v8context_get_current_context:PCefV8context; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  // Returns the entered (bottom) context object in the V8 context stack.
  function cef_v8context_get_entered_context:PCefV8context; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  // Returns true (1) if V8 is currently inside a context.
  function cef_v8context_in_context: cint; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  // Create a new cef_v8value_t object of type undefined.
  function cef_v8value_create_undefined:PCefV8value; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  // Create a new cef_v8value_t object of type null.
  function cef_v8value_create_null:PCefV8value; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  // Create a new cef_v8value_t object of type bool.
  function cef_v8value_create_bool(value: cint):PCefV8value; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  // Create a new cef_v8value_t object of type int.
  function cef_v8value_create_int(value: cint32):PCefV8value; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  // Create a new cef_v8value_t object of type unsigned int.
  function cef_v8value_create_uint(value: cuint32):PCefV8value; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  // Create a new cef_v8value_t object of type double.
  function cef_v8value_create_double(value: cdouble):PCefV8value; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  ...
  function cef_v8value_create_date(const date:PCefTime):PCefV8value; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  // Create a new cef_v8value_t object of type string.
  function cef_v8value_create_string(const value:PCefString):PCefV8value; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  ...
  // reference.
  function cef_v8value_create_object(accessor:PCefV8accessor):PCefV8value; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  ...
  function cef_v8value_create_array(length: cint):PCefV8value; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  // Create a new cef_v8value_t object of type function.
  function cef_v8value_create_function(const name:PCefString; handler:PCefV8handler):PCefV8value; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  // Returns the stack trace for the currently active context. |frame_limit| is
  // the maximum number of frames that will be captured.
  function cef_v8stack_trace_get_current(frame_limit: cint):PCefV8stackTrace; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};

  {----------------------------CefValuesCApi-----------------------------------}
  // Creates a new object that is not owned by any other object. The specified
  // |data| will be copied.
  function cef_binary_value_create(const data:Pointer; data_size:Cardinal):PCefBinaryValue; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  // Creates a new object that is not owned by any other object.
  function cef_dictionary_value_create:PCefDictionaryValue; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  // Creates a new object that is not owned by any other object.
  function cef_list_value_create:PCefListValue; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};

  {----------------------------CefWebPluginCApi--------------------------------}
  // Visit web plugin information.
  procedure cef_visit_web_plugin_info(visitor:PCefWebPluginInfoVisitor); cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  // Cause the plugin list to refresh the next time it is accessed regardless of
  // whether it has already been loaded. Can be called on any thread in the
  // browser process.
  procedure cef_refresh_web_plugins; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  // Add a plugin path (directory + file). This change may not take affect until
  // after cef_refresh_web_plugins() is called. Can be called on any thread in the
  // browser process.
  procedure cef_add_web_plugin_path(const path:PCefString); cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  // Add a plugin directory. This change may not take affect until after
  // cef_refresh_web_plugins() is called. Can be called on any thread in the
  // browser process.
  procedure cef_add_web_plugin_directory(const dir:PCefString); cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  // Remove a plugin path (directory + file). This change may not take affect
  // until after cef_refresh_web_plugins() is called. Can be called on any thread
  // in the browser process.
  procedure cef_remove_web_plugin_path(const path:PCefString); cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  // Unregister an internal plugin. This may be undone the next time
  // cef_refresh_web_plugins() is called. Can be called on any thread in the
  // browser process.
  procedure cef_unregister_internal_web_plugin(const path:PCefString); cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  // Force a plugin to shutdown. Can be called on any thread in the browser
  // process but will be executed on the IO thread.
  procedure cef_force_web_plugin_shutdown(const path:PCefString); cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  // Register a plugin crash. Can be called on any thread in the browser process
  // but will be executed on the IO thread.
  procedure cef_register_web_plugin_crash(const path:PCefString); cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
  // Query if a plugin is unstable. Can be called on any thread in the browser
  // process.
  procedure cef_is_web_plugin_unstable(const path:PCefString; callback:PCefWebPluginUnstableCallback); cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};

  {----------------------------CefXMLreaderCApi--------------------------------}
  // Create a new cef_xml_reader_t object. The returned object's functions can
  // only be called from the thread that created the object.
  function cef_xml_reader_create(stream:PCefStreamReader; encodingType:TCefXmlEncodingType;
    const URI:PCefString):PCefXmlReader; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};

  {----------------------------CefZipreaderCApi--------------------------------}
  // Create a new cef_zip_reader_t object. The returned object's functions can
  // only be called from the thread that created the object.
  function cef_zip_reader_create(stream:PCefStreamReader):PCefZipReader; cdecl; external CefLibrary delayed {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
...
var
  ...
  // |windows_sandbox_info| parameter is only used on Windows and may be NULL (see
  // cef_sandbox_win.h for details).
  cef_execute_process: function(const args:PCefMainArgs; application:PCefApp; windows_sandbox_info:Pointer): cint; cdecl;
  // This function should be called on the main application thread to initialize
  // the CEF browser process. The |application| parameter may be NULL. A return
  // value of true (1) indicates that it succeeded and false (0) indicates that it
  // failed. The |windows_sandbox_info| parameter is only used on Windows and may
  // be NULL (see cef_sandbox_win.h for details).
  cef_initialize: function(const args:PCefMainArgs; const settings:PCefSettings; application:PCefApp; windows_sandbox_info:Pointer): cint; cdecl;
  // This function should be called on the main application thread to shut down
  // the CEF browser process before the application exits.
  ...
  cef_browser_host_create_browser: function(const windowInfo:PCefWindowInfo;
    client:PCefClient; const url:PCefString; const settings:PCefBrowserSettings;
    request_context:PCefRequestContext): cint; cdecl;

  // Create a new browser window using the window parameters specified by
  // |windowInfo|. This function can only be called on the browser process UI
  // thread.
  cef_browser_host_create_browser_sync: function(const windowInfo:PCefWindowInfo;
    client:PCefClient; const url:PCefString; const settings:PCefBrowserSettings;
    request_context:PCefRequestContext):PCefBrowser; cdecl;
  ...
  // to be transient and most Web browsers do not persist them. Returns NULL if
  // creation fails.
  cef_cookie_manager_create_manager: function(const path:PCefString; persist_session_cookies: cint):PCefCookieManager; cdecl;
  ...
  // This function may be called on any thread. Returns false (0) if
  // |source_origin| is invalid or the whitelist cannot be accessed.
  cef_add_cross_origin_whitelist_entry: function(const source_origin:PCefString;
    const target_protocol: PCefString; const target_domain:PCefString; allow_target_subdomains: cint): cint; cdecl;
  // Remove an entry from the cross-origin access whitelist. Returns false (0) if
  // |source_origin| is invalid or the whitelist cannot be accessed.
  cef_remove_cross_origin_whitelist_entry: function(const source_origin:PCefString;
    const target_protocol:PCefString; const target_domain:PCefString; allow_target_subdomains: cint): cint; cdecl;
  // Remove all entries from the cross-origin access whitelist. Returns false (0)
  // if the whitelist cannot be accessed.
  ...
  // matches the specified |scheme_name| and optional |domain_name|. Returns false
  // (0) if an error occurs. This function may be called on any thread.
  cef_register_scheme_handler_factory: function(const scheme_name:PCefString;
    const domain_name:PCefString; factory:PCefSchemeHandlerFactory): cint; cdecl;
  // Clear all registered scheme handler factories. Returns false (0) on error.
  // This function may be called on any thread.
  ...
  // Parse the specified |url| into its component parts. Returns false (0) if the
  // URL is NULL or invalid.
  cef_parse_url: function(const url:PCefString; var parts:TCefUrlparts): cint; cdecl;
  // Creates a URL from the specified |parts|, which must contain a non-NULL spec
  // or a non-NULL host and path (at a minimum), but not both. Returns false (0)
  // if |parts| isn't initialized as described.
  ...
  //   example.test.increment();
  // </pre>
  cef_register_extension: function(const extension_name:PCefString; const javascript_code:PCefString;
    handler:PCefV8handler): cint; cdecl;
  // Returns the current (top) context object in the V8 context stack.
  ...
  // cef_v8accessor_t callback, or in combination with calling enter() and exit()
  // on a stored cef_v8context_t reference.
  cef_v8value_create_date: function(const date:PCefTime):PCefV8value; cdecl;
  // Create a new cef_v8value_t object of type string.
  ...
  cef_xml_reader_create: function(stream:PCefStreamReader; encodingType:TCefXmlEncodingType;
    const URI:PCefString):PCefXmlReader; cdecl;
