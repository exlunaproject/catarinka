...
const
  ...
  //............................................................................cef_app_capi
	...
	function cef_cookie_manager_get_global_manager: PCefCookieManager; cdecl; external CefLibrary {$IFNDEF FPC}delayed{$ENDIF} {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
	...
	// creation fails
	function cef_cookie_manager_create_manager(const path: PCefString; persist_session_cookies: cint): PCefCookieManager; cdecl; external CefLibrary {$IFNDEF FPC}delayed{$ENDIF} {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
	//............................................................................cef_drag_data_capi
	...
	function cef_request_context_create_context(handler: PCefRequestContextHandler): PCefRequestContext; cdecl; external CefLibrary {$IFNDEF FPC}delayed{$ENDIF} {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
	//............................................................................cef_response_capi
	...
	function cef_urlrequest_create(request: PCefRequest; client: PCefUrlrequestClient): PCefUrlrequest; cdecl; external CefLibrary {$IFNDEF FPC}delayed{$ENDIF} {$IFDEF SUPPORTS_INLINE}inline{$ENDIF};
	//............................................................................cef_url_capi
...
var
  ...
  //............................................................................cef_app_capi
	...
	// |windows_sandbox_info| parameter is only used on Windows and may be NULL (see
	// cef_sandbox_win.h for details
	cef_execute_process: function(const args: PCefMainArgs; application: PCefApp; windows_sandbox_info: void): cint; cdecl;
	//This function should be called on the main application thread to initialize
	// the CEF browser process. The |application| parameter may be NULL. A return
	// value of true (1) indicates that it succeeded and false (0) indicates that it
	// failed. The |windows_sandbox_info| parameter is only used on Windows and may
	// be NULL (see cef_sandbox_win.h for details
	cef_initialize: function(const args: PCefMainArgs; const settings: PCefSettings; application: PCefApp; windows_sandbox_info: void): cint; cdecl;
	//This function should be called on the main application thread to shut down
	// the CEF browser process before the application exits
	...
	// context will be used. This function can be called on any browser process
	// thread and will not block
	cef_browser_host_create_browser: function(const windowInfo: PCefWindowInfo; client: PCefClient; const url: PCefString; const settings: PCefBrowserSettings; request_context: PCefRequestContext): cint; cdecl;
	//Create a new browser window using the window parameters specified by
	// |windowInfo|. If |request_context| is NULL the global request context will be
	// used. This function can only be called on the browser process UI thread
	...
	//Create a new cef_stream_reader_t object from data
	cef_stream_reader_create_for_data: function(data: void; size: csize_t): PCefStreamReader; cdecl;
	//Create a new cef_stream_reader_t object from a custom handler
	...
	//Creates a new object that is not owned by any other object. The specified
	// |data| will be copied
	cef_binary_value_create: function(const data: void; data_size: csize_t): PCefBinaryValue; cdecl;
	//Creates a new object that is not owned by any other object
